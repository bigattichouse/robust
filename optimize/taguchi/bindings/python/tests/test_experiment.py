...
# ---- merged from test_experiment_enhanced.py ----
import tempfile
import pytest
from unittest.mock import Mock, patch
from taguchi.config import TaguchiConfig
from taguchi.core import Taguchi
from taguchi.experiment import Experiment, _validate_factor_name, _validate_levels
...
class TestExperimentEnhanced:
    ...
    def test_init_default(self, mock_taguchi):
        ...
        with patch('taguchi.experiment.Taguchi', return_value=mock_taguchi):
            exp = Experiment()
    ...
    def test_init_with_config(self):
        ...
        with patch('taguchi.experiment.Taguchi') as mock_taguchi_class:
